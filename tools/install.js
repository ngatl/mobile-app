...
var backendRepoPath = '/Users/WinnerGuy/Projects/_nscript/colmena/packages/admin-lb-sdk-ns/src/'; // '/Users/nathan/Documents/github/ngatl/colmena/packages/admin-lb-sdk-ns/src'
...
if (!fs.existsSync(resolve(nativescriptAppPath))) {
    ...
    console.log("  ", resolve(backendRepoPath), "    - to - ");
...
function createRootSymLink() {
    ...
    var p2 = resolve(backendRepoPath);
    if (debugging) {
...
function createSymLink() {
    if (debugging) {
        console.log("Attempting to Symlink", backendRepoPath, nativescriptAppPath);
    }
    fs.symlinkSync(resolve(backendRepoPath), resolve(nativescriptAppPath), 'junction');
}
...
{
    console.log("------------------------ ngAtl App is Now Ready ----------------------------");
    console.log("");
    console.log("Run the app via NativeScript with:");
    console.log("  iOS:     tns run ios");
    console.log("  Android: tns run android");
    console.log("");
    console.log("-----------------------------------------------------------------------------------------");
    console.log("");
}
